/**
 * Minimal inline SVG icon set (Lucide geometry) — avoids an icon dependency and
 * guarantees no emoji is ever used as an interface icon.
 */
...
/** Icons with filled geometry rather than stroked paths. */
